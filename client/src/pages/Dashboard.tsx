...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5]">
          ...
          <Card className="border-0 bg-white/50">
            <CardContent className="p-3">
              <div className="flex items-center justify-between gap-2 mb-2">
                ...
                {venturesCards.length > 0 && (
                  <Button
                    size="sm"
                    variant="ghost"
                    className="h-6 px-2 text-xs"
                    onClick={() => {
                      setEditingVenture(venturesCards[0]);
                      setIsVentureEditOpen(true);
                    }}
                  >
              ...
              <div className="space-y-2">
                ...
                {venturesCards.length > 0 && (
                  <div className="text-xs text-muted-foreground mt-2 pt-2 border-t">
                    <p className="font-medium text-foreground mb-1">Recent Ventures:</p>
                    <div className="space-y-2 max-h-32 overflow-y-auto">
                      {venturesCards.slice(0, 3).map((card: any) => (
                        <div
                          key={card.id}
                        ...
                        >
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            className="ml-2 h-6 px-2 text-purple-600 hover:text-purple-900 hover:bg-purple-200"
                            onClick={(e) => {
                              e.stopPropagation();
                              setEditingVenture(card);
                              setIsVentureEditOpen(true);
                            }}
                          >
                            <Edit2 className="h-3 w-3" />
      ...
      {/* Venture Edit Modal */}
      <VentureEditModal
        isOpen={isVentureEditOpen}
        onClose={() => {
          setIsVentureEditOpen(false);
